 ...
 *
 */
public class FluidTransformerMetadata extends TransformerMetadata {
	...
	protected TransformerMetadata getNewInstance() {
		return new FluidTransformerMetadata();
	}
	...
	protected void assignTransformer(TransformerMetadata data, String transformerName, String transformerOwner,
		...
		FluidTransformerMetadata md = (FluidTransformerMetadata) data;
		md.target = target;
